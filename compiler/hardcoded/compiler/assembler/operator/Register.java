...
import static hardcoded.compiler.assembler.operator.RegisterType.*;
...
public enum Register {
	...
	R8L(r8, 8),   R8W(r16, 8),   R8D(r32, 8),   R8(r64, 8),            /* MMX0 */       XMM8(xmm, 8),   YMM8(ymm, 8),  /* ES */        CR8(control, 8),   DR8(debug, 8),
	R9L(r8, 9),   R9W(r16, 9),   R9D(r32, 9),   R9(r64, 9),            /* MMX1 */       XMM9(xmm, 9),   YMM9(ymm, 9),  /* CS */        CR9(control, 9),   DR9(debug, 9),
	R10L(r8, 10), R10W(r16, 10), R10D(r32, 10), R10(r64, 10),          /* MMX2 */       XMM10(xmm, 10), YMM10(ymm, 10),/* SS */        CR10(control, 10), DR10(debug, 10),
	R11L(r8, 11), R11W(r16, 11), R11D(r32, 11), R11(r64, 11),          /* MMX3 */       XMM11(xmm, 11), YMM11(ymm, 11),/* DS */        CR11(control, 11), DR11(debug, 11),
	R12L(r8, 12), R12W(r16, 12), R12D(r32, 12), R12(r64, 12),          /* MMX4 */       XMM12(xmm, 12), YMM12(ymm, 12),/* FS */        CR12(control, 12), DR12(debug, 12),
	R13L(r8, 13), R13W(r16, 13), R13D(r32, 13), R13(r64, 13),          /* MMX5 */       XMM13(xmm, 13), YMM13(ymm, 13),/* GS */        CR13(control, 13), DR13(debug, 13),
	R14L(r8, 14), R14W(r16, 14), R14D(r32, 14), R14(r64, 14),          /* MMX6 */       XMM14(xmm, 14), YMM14(ymm, 14),                CR14(control, 14), DR14(debug, 14),
	R15L(r8, 15), R15W(r16, 15), R15D(r32, 15), R15(r64, 15),          /* MMX7 */       XMM15(xmm, 15), YMM15(ymm, 15),                CR15(control, 15), DR15(debug, 15),
	...
	private Register(RegisterType type, int index) {
		this.type = type;
		this.bits = (type == null ? 0:type.bits);
		this.index = index;
	}
	
	private Register(RegisterType type, int bits, int index) {
		this.type = type;
		this.bits = bits;
		this.index = index;
	}
	 ...
	 */
	private static final Register[][] registers = { // 11 types
		{ AL, CL, DL, BL, AH, CH, DH, BH, R8L, R9L, R10L, R11L, R12L, R13L, R14L, R15L },							// r8
	 ...
	 */
	public static Register get(RegisterType type, int index) {
		...
		Register[] array = registers[type.ordinal()];
		for(Register reg : array) {
