...
public enum Instructions {
	...
	sub,		// sub			[R0], [R1], [R2]				R0 = (R1 - R2)							R0 = add(R1, not(R2))
	...
	shr,		// shr			[R0], [R1], [R2]				R0 = (R1>> R2)
	shl,		// shl			[R0], [R1], [R2]				R0 = (R1<< R2)
	neg,		// neg			[R0], [R1]						R0 = (-R1)
	nor,		// nor			[R0], [R1]						R0 = (~R1)
	not,		// not			[R0], [R1]						R0 = (!R1)
	 ...
	 */
	eq,			// eq			[R0], [R1], [R2]				R0 = (R1== R2)							R0 = not(R1 - R2)
	neq,		// neq			[R0], [R1], [R2]				R0 = (R1!= R2)							R0 = not(not(R1 - R2))
	lt,			// lt			[R0], [R1], [R2]				R0 = (R1 < R2)
	lte,		// lte			[R0], [R1], [R2]				R0 = (R1<= R2)
	gt,			// gt			[R0], [R1], [R2]				R0 = (R1 > R2)
	gte,		// gte			[R0], [R1], [R2]				R0 = (R1>= R2)
	...
	public static final Instructions convert(ExprType type) {
		switch(type) {
			case nop: return nop;
