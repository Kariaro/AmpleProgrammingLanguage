...
import me.hardcoded.compiler.constants.*;
import me.hardcoded.compiler.constants.Modifiers.Modifier;
import me.hardcoded.compiler.context.LangContext;
import me.hardcoded.compiler.errors.*;
import me.hardcoded.compiler.expression.*;
import me.hardcoded.compiler.impl.*;
import me.hardcoded.compiler.statement.*;
import me.hardcoded.compiler.types.ConstructType;
import me.hardcoded.compiler.types.HighType;
import me.hardcoded.compiler.types.PrimitiveType;
...
import me.hardcoded.lexer.TypeGroups;
import me.hardcoded.utils.*;
				...
				Expression e2_2() {
					switch(reader.type()) {
						case INCREMENT, DECREMENT -> {
							ExprType dir = reader.type() == Type.INCREMENT ? add:sub;
