...
import static me.hardcoded.exporter.x86.AssemblyConsts.*;
...
final class AsmLoader {
	...
	static {
		...
		try {
			list = loadInstructions("/assembler/insts_x86.dat");
		} catch(IOException e) {
			e.printStackTrace();
			System.err.println("Failed to load instructions : '/assembler/insts_x86.dat'");
		}
